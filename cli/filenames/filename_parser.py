...
if __name__ == '__main__':
    ...
    #retval = parse_path_and_file( "/share/mikro3/squid/anders/test-new-squid/B02_s1_x0_y0_z0_Fluorescence_561_nm_Ex.tiff")
    #print("\nretval = " + str(retval))
    ...
    retval = parse_path_and_file( "/share/data/external-datasets/christa-patient-painting/CRC-119-Growdex-10X-stained/2025-10-15/25490/TimePoint_1/CRC-119-Growdex-10X-stained_I03_s4_w2F854777A-4769-4D27-85DD-C6F45EA1790F.tif")
    print("\nretval = " + str(retval))
